...
export const getProperties = async (req: Request, res: Response): Promise<void> => {
   try {
      ...
      res.status(500).json({ message: `Error retreiving properties: ${error.message}` });
   }
};
...
export const getProperty = async (req: Request, res: Response): Promise<void> => {
   try {
      ...
      res.status(500).json({ message: `Error retreiving property: ${error.message}` });
   }
};
