    ...
    <div className="flex justify-between items-center w-full py-5">
      <div className="flex justify-between items-center gap-4 p-2">
        <Button
          variant="outline"
          className={cn(
            "gap-2 rounded-xl border-primary-400 hover:bg-primary-500 hover:text-primary",
            isFiltersFullOpen && "bg-primary-700 text-primary-50",
          )}
        ...
        <div className="flex gap-1">
          ...
          >
            <SelectTrigger className="max-w-36 rounded-xl border-primary-400">
        ...
        <div className="flex gap-1">
          ...
          >
            <SelectTrigger className="max-w-44 rounded-xl border-primary-400">
