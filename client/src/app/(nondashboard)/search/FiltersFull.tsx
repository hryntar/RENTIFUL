    ...
    <div className="bg-white rounded-lg px-4 h-full overflow-auto pb-10">
      <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(AmenityIcons).map(([amenity, Icon]) => (
              ...
              >
                ...
                <Label className="cursor-pointer">{formatEnumString(amenity)}</Label>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex gap-4 mt-6">
          <Button className="flex-1 bg-primary-700 text-white rounded-xl" onClick={handleSubmit}>
            APPLY
          </Button>
          <Button className="flex-1 rounded-xl" variant="outline" onClick={handleReset}>
            Reset Filters
          </Button>
        </div>
      </div>
